...
def main():
    ...
    print(f"Parsing: /Users/fredbliss/workspace/treasure/trails.kml")

    # Parse KML
    tree = ET.parse('/Users/fredbliss/workspace/treasure/trails.kml')
    root = tree.getroot()
    ...
    for placemark in root.findall('.//kml:Placemark', NS):
        ...
        name = name_elem.text if name_elem is not None else f"Trail {stats['total_trails']}"
    ...
    geojson_path = '/Users/fredbliss/workspace/treasure/data/trails.geojson'
    ...
    # Write CSV
    csv_path = '/Users/fredbliss/workspace/treasure/data/trails_summary.csv'
    print(f"\nWriting CSV to: {csv_path}")
    with open(csv_path, 'w', newline='') as f:
        fieldnames = ['name', 'osm_id', 'county', 'distance_miles',
                      'highway_type', 'surface', 'difficulty', 'ref', 'num_coordinates']
    ...
    stats_export = {
        ...
        'by_county': {
            county: {
                ...
                'avg_miles_per_trail': round(stats['county_miles'][county] / stats['county_counts'][county], 2)
            }
        ...
        'buncombe_county_summary': {
            ...
            'percentage_of_total': round(100 * stats['county_counts']['Buncombe'] / stats['total_trails'], 2)
        }
    }

    stats_path = '/Users/fredbliss/workspace/treasure/data/trails_statistics.json'
    ...
    print(f"Average Trail Length: {stats['total_miles'] / stats['total_trails']:.2f} miles")
    ...
    for i, trail in enumerate(trails[:10], 1):
        print(f"  {i}. {trail['name']} ({trail['county']} County): {trail['distance_miles']:.2f} miles")
