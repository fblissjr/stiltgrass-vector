...
print("  ┌─────────────────────────────────────────────────────┐")
print("  │  Center: 35.60°N, 82.45°W                          │")
print("  │  Elevation: 3,000-3,200 ft                         │")
print("  │  Drive time: 175-179 minutes from Charlotte        │")
print("  │  Surface: Ground/Dirt (68% of trails)              │")
print("  │  Difficulty: Grade 2-3 (moderate)                  │")
print("  │  Cell coverage: Good (AT&T + Verizon)              │")
print("  └─────────────────────────────────────────────────────┘")
print()
...
for i, trail in enumerate(candidates[:5], 1):
    ...
    print(f"   📍 {trail['latitude']}, {trail['longitude']}")
    print(f"   ⛰️  Elevation: {trail['elevation_ft']} ft")
    print(f"   🚗 Drive time: {trail['drive_time_min']} min")
    print(f"   🌱 Surface: {trail['surface']} | Difficulty: {trail['difficulty']}")
    print()

print("SCORING BREAKDOWN (Trail 135266420 - Top Candidate):")
print("-" * 80)
print(f"  ✓ Surface (ground):          40 points")
print(f"  ✓ Difficulty (grade3):       30 points")
print(f"  ✓ Buncombe County:           20 points")
print(f"  ✓ Stilt grass habitat:       15 points")
print(f"  ✓ Cell coverage (good):       8 points")
print(f"  ✓ Optimal elevation:         10 points")
print(f"  ✗ Forest Service road:        0 points (not tagged)")
print(f"  ✗ Named trail:                0 points (unnamed)")
print(f"  " + "─" * 40)
...
print("-" * 80)
print()
print("  🎯 BENT CREEK EXPERIMENTAL FOREST")
print("     Pisgah National Forest, Buncombe County, NC")
print()
print("  Trail Systems:")
print("    • Berea Trail Network (14 top candidates)")
print("    • Blue Ridge Parkway Access Trails (7 candidates)")
print("    • Mountains-to-Sea Trail segments (3 candidates)")
print("    • Dam Pasture / Bull Creek trails (8 candidates)")
print()
print("  Access Points:")
print("    • Blue Ridge Parkway (multiple access points)")
print("    • Bent Creek Gap Road (FS 479)")
print("    • NC Route 191 (Brevard Road)")
print()

print("VALIDATION CHECKS:")
print("-" * 80)
print(f"  ✓ Temperature (55°F @ midnight):  Matches 3,100 ft elevation")
print(f"  ✓ Drive time (2.9-3.0 hours):     Within 1-3 hour constraint")
print(f"  ✓ Cellular coverage:              Ridge location, dual-carrier OK")
print(f"  ✓ Trail surface:                  Ground/dirt ideal for burial")
print(f"  ✓ Accessibility:                  Moderate difficulty, public land")
print()
